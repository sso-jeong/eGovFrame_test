...
<br/>
<div class="container">
        <form id="writeForm" name="writeForm" method="post" encType="multiplart/form-data">
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <th>내용</th>
                        <td><textarea placeholder="내용을 입력하세요 ." name="CONTENTS" class="form-control" value="${detail.CONTENTS}" style="height: 200px;"></textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2">
